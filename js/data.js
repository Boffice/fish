...
// `countries` (optional) overrides the default "ge" country filter — needed
// for transboundary lakes like Jandari whose OSM polygon is tagged on the
// neighbouring side of the border.
export const LAKES = [
  ...
  { id: "jandari",    name: "Jandari Lake",    region: "Kvemo Kartli",       lat: 41.443, lon: 45.176, elevation: 295,  search: "ჯანდარის ტბა", countries: "ge,az" },
...
//
// tempOpt   : [min, max] water-temperature comfort band (°C). Scoring uses
//             Open-Meteo's shallow soil temperature as a lake-water proxy
//             (better than air temp, which lags by weeks at altitude).
...
//             Scoring shifts this curve backwards at altitude (~1 month per
//             1000 m above 500 m) — alpine "spring" arrives later.
// lakes     : lake ids where this species is actually found. "Any fish" mode
//             skips lakes that aren't on the list, so catfish never gets
//             recommended on an alpine lake. Best-effort, edit freely.
export const SPECIES = [
  {
    ...
    lakes: ["paravani", "tabatskuri", "sagamo", "madatapa", "tsalka", "sioni", "shaori"],
  ...
  },
  {
    ...
    lakes: ["khanchali", "kartsakhi", "bazaleti", "tbilisisea", "lisi", "kumisi", "jandari", "tkibuli"],
  ...
  },
  {
    ...
    lakes: ["khanchali", "kartsakhi", "tsalka", "bazaleti", "sioni", "tkibuli", "jandari"],
  ...
  },
  {
    ...
    lakes: ["paravani", "sagamo", "khanchali", "kartsakhi", "tsalka", "bazaleti", "tbilisisea", "lisi", "kumisi", "jandari", "sioni", "shaori", "tkibuli"],
  ...
  },
  {
    ...
    lakes: ["tsalka", "tbilisisea", "jandari", "sioni", "tkibuli", "shaori"],
  ...
  },
  {
    ...
    lakes: ["tbilisisea", "kumisi", "jandari", "tkibuli"],
  ...
  },
  {
    ...
    lakes: ["bazaleti", "tbilisisea", "kumisi", "jandari", "tkibuli"],
  ...
  },
  {
    ...
    lakes: ["khanchali", "kartsakhi", "bazaleti", "tbilisisea", "lisi", "kumisi", "jandari", "sioni", "tkibuli"],
  ...
  },
  {
    ...
    lakes: ["paravani", "tabatskuri", "madatapa"],
